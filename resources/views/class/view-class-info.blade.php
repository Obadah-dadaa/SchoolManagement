                ...
                <section class="breadcumb-area card bg-gradient mb-5">
                    <div class="bread-cumb-content card-body d-flex align-items-center">
                        <div class="breadcumb-heading">
                            <h2 class="text-white" style="padding-left:200px; font-size:40px;">استعراض معلومات صف</h2>
                        </div>
                        <div class="breadcumb-image ml-auto">
                            <img src="../../assets/img/class1.png" style="margin-top:230px;" height="250px" width="250px" alt="">
                        </div>
                    </div>
                </section>
                <!-- End breadcumb-area -->
                            ...
                            <form action="" method="POST" class="es-form">
                                ...
                                <div class="row" style="margin-right:3%">
                                    ...
                                    <div class="col-md-6  mb-2">
                                        ...
                                        <input  name="section"  placeholder="الشعبة">
                                    </div>
                                </div>
                                <div class="row" style="margin-right:10%">
                                    <div class="col-md-8  mb-2">
                                        ...
                                        line-height: 20px;
                                        text-align: center;" class="btn btn-danger align-items-center"> إضافة </button>
                                    </div>
                                </div>
                            </form>
                        </div>
