                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0" style="padding-left:190px; margin-top:10px;"> مدرسة دار الحكمة الخاصة </h2>
                        </header>
                        <div class="breadcumb-image ml-auto">
                            <img src="../../assets/img/class1.png" style="margin-bottom:1170px;" height="250px" width="250px" alt="">
                        </div>
                        <br>
                        <div class="card-body col-lg-10" style="margin-left:8%;">
                            <form action="{{ route('grade.store') }}" method="POST" class="es-form es-add-form">
                                @csrf
                                <div class="row" style="margin-right:3%">
                                    <div class="col-md-6  mb-2">
                                        <label for="title"> الصف  :</label>
                                        <input required name="name" type="text" placeholder="  الصف ">
                                    </div>
                                    <div class="col-md-6  mb-2">
                                        <label for="class"  class="label-align"> الشعبة  :</label>
                                        <select  name="number[]"  class="form-control selectpicker" data-live-search="true" >
                            ...
                            <div class="attendances-list-wrap mt-5">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        <thead class="bg-gradient">
                                            <th scope="col" class="text-white text-center">المواد</th>
                                            <th scope="col" class="text-white text-center">الأساتذة</th>
                                         </thead>          
                                        <tbody>
                                        @foreach ($subject as $item )
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <select name="teacher[][]"  class="form-control selectpicker" data-live-search="true" multiple>
                                                    @foreach ($teacher as $items )
                                                    <option  value='{"student_id":{{ $items->id }}, "subject_id":{{ $item->id }}}'> {{ $items->name }}</option>
                                                    @endforeach
                                                    </select>
                                                </td>
                                            </tr>
                                ...
                                <br>
                                <div class=" col-md-6 mb-2" style="padding-right:50%">
                                    <button type="submit" class="btn btn-danger align-items-center"> إضافة </button>
                                </div>
                            </div>
                        </div>
                       </form>
