                ...
                <section class="profile-area card">
                    <div class="profile-content card-body  d-flex">
                        <div class="user-image-wrap mr-5">
                            <img src="../../assets/img/parent-profile.png" style="padding-right:10%; padding-top:5%; " height="110%" width="110%" alt="">
                        </div>
                        <div class="m-3" style="padding-top:32%;">
                            <a href="{{ route('parent.destroy',['id'=>$parent->id])}}" class="btn btn-outline-danger pl-4 pr-4">حذف</a>
                            <a href="{{ route('parent.edit',['id'=>$parent->id])}}" class="btn btn-outline-danger pl-4  pr-4">تعديل </a>
                        </div>
                        <div class="user-about p-2">
                            <br>
                            <p class="text-danger" style="padding-left:26%">  الاسم : <span> {{ $parent->name}} </span></p>
                            <p style="padding-left:0%"> <span>{{ $parent->email }} </span> :البريد </p>
                            <p style="padding-left:0%"> <span> {{$parent->phone_number}}  </span> :رقم الهاتف</p>
                            <p style="margin-left:30%"> <span> {{$parent->address}}  </span> :العنوان </p>
                        </div>
                    </div>
                </section>
            </div>
