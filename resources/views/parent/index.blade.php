            ...
            <section class="breadcumb-area card bg-gradient mb-5">
                <div class="bread-cumb-content card-body d-flex align-items-center">
                    <div class="breadcumb-heading">
                        <span class="text-white" style="padding-left:120px; font-size:50px;">أولياء الأمور </span>
                    </div>
                    <div class="breadcumb-image ml-auto">
                        <img src="../../assets/img/parent.png" wstyle="margin-top:300px;" height="310px" width="300px">
                    </div>
                </div>
            </section>
            <!-- End breadcumb-area -->
                                ...
                                <table class="table mb-6">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="{{ route('parent.show',['id'=>$item->id])}}" class="btn  btn-outline-dark  es-am-btn">الحساب الشخصي</a></td>
