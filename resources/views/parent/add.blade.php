                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0" style="padding-left:300px; padding-right:300px;">إضافة  ولي أمر </h2>
                        </header>
                        <div class="breadcumb-image ml-auto" style="padding-right:140px;">
                            <img src="../../assets/img/parent.png" style="margin-bottom: 200%;" height="210px" width="210px" alt="">
                        </div>
                        <br>
                        <div class="card-body col-lg-10" style="margin-left:8%;">
                            <form action="{{ route('parent.store') }}" method="POST" class="es-form es-add-form was-validated">
                                @csrf
                                <div class="row" style="margin-right:3%">
                                    <div class="col-md-6  mb-2">
                                        <label for="title">اسم ولي الأمر :</label>
                                        <input required name="name" type="text" placeholder=" اسم الولي ">
                                    </div>
                                    <div class="col-md-6  mb-2">
                                        <label for="title">العنوان :</label>
                                        <input required  name="address" type="text" placeholder="العنوان">
                                    </div>
                                </div>
                                    <div class="row" style="margin-right:3%">
                                        <div class="col-md-6  mb-2">
                                    ...
                                    <div class="row" style="margin-right:3%">
                                        ...
                                        <input required name="password"  placeholder="كلمة سر">
                                    </div>
                                        <div class="col-md-6  mb-2">
                                        <label for="title">إعادة إدخال كلمة السر:</label>
                                        <input required  name="c-password"  placeholder="كلمة سر">
                                    </div>
                                    <div class=" col-md-7 mb-2">
                                        <br>
                                        <button type="submit" class="btn bg-gradient align-items-center"> إضافة الولي</button>
                                    </div>
                                </div>
                            </form>
                        </div>
