        ...
        <div class="u-content">
            <div class="u-body">
                ...
                <div class="row">
                        ...
                        <div class="single-asset-counting-list-box bg-gradient bg-gradient-purple card border-0 text-center">
                            <div class="card-body">
                                <div class="single-asset-counting-list-image-wrap">
                                    <img src="../assets/img/student.png" style="padding-bottom:24%;"  width="50%" alt="">
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-asset-counting-list-box bg-gradient-red card border-0 text-center">
                            <div class="card-body">
                                <div class="single-asset-counting-list-image-wrap">
                                    <img src="../assets/img/teacher.png" alt="">
                                </div>
                                <h2 class="text-white mb-0">15 <small class="d-block mt-2">عدد الأساتذة  </small></h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-asset-counting-list-box bg-gradient bg-gradient-purple card border-0 text-center">
                            <div class="card-body">
                                <div class="single-asset-counting-list-image-wrap">
                                    <img src="../assets/img/parent1.png" style="padding-bottom:24%;"  width="70%" alt="">
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-asset-counting-list-box bg-gradient bg-gradient-red card border-0 text-center">
                            <div class="card-body">
                                <div class="single-asset-counting-list-image-wrap">
