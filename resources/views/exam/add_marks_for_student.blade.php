                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0" style="padding-left:300px; font-size:50px;">إضافة علامة جديدة</h2>
                        </header>
                        <br>
                        <div class="card-body col-lg-8 p-lg-2">
                            <form action="{{ route('exam.store') }}" method="POST" class="es-form es-add-form was-validated">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="class">الصف :</label>
                                        <select name="grade"  class="add-select">
                                            @foreach ( $grade as $item )
                                            <option  value={{ $ids_array['grade_id'] }} selected> {{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="section">الشعبة :</label>
                                        <select name="section" class="add-select">
                                                 <option selected> {{ $request->section }}</option>
                                        </select>
                                    </div>
                                     <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="subject">المادة :</label>
                                        <select name="subject"  class="add-select">
                                        @foreach ( $subject as $item )
                                        <option  value={{ $ids_array['subject_id'] }} selected> {{ $item->name }}</option>
                                        @endforeach
                                        </select>
                                    </div>
									    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="type">خاص ب :</label>
                                        <select name="type" class="add-select">
                                        <option> {{ $request->type }}</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="marks"> العلامة الكاملة : </label>
                                        <input disabled id="marks" type="text" value={{ $request->total_mark }}>
                                    </div>
                                </div>
                                <div class="row">
                               <div class="attendances-list-wrap mt-5">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        <thead class="bg-gradient">
                                            <tr>
												...
												<th scope="col" class="text-white text-center">العلامة</th>
                                                <th scope="col" class="text-white text-center"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <input name="mark" type="text" placeholder="100">
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    ...
                                    <br>
                                    <td class="text-center" ><button type="submit" class="btn  btn-outline-dark  es-am-btn"> إدخال العلامات  </button>
