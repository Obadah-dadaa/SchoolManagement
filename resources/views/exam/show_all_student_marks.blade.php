        ...
        <div class="u-content">
            <div class="u-body">
                ...
                <section class="breadcumb-area card bg-gradient mb-5">
                    <div class="bread-cumb-content card-body d-flex align-items-center">
                        <div class="breadcumb-heading">
                            <h2 class="text-white" style="padding-left:200px; font-size:40px;">استعراض علامات طالب</h2>
                        </div>
                ...
                <section class="es-form-area">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('exam.show-marks-for-student') }}" method="POST" class="es-form">
                                @csrf
                                <div class="row align-items-center">
                                    <div class="col">
                                        <label for="title"> اسم الطالب:</label>
                                        <input  name="first_name"  placeholder=" اسم الطالب">
                                    </div>
                                    <div class="col">
                                        <label for="title"> الكنية</label>
                                        <input  name="last_name"  placeholder=" الكنية">
                                    </div>
                                    <div class="col">
                                        <label for="title"> اسم الولي:</label>
                                        <input  name="parent"  placeholder=" اسم الولي">
                                    </div>
                                    ...
                                    <div class="col">
                                        <button type="submit" style="padding-left: 50%; margin-top:14%; margin-left:10%;" class="btn bg-gradient align-items-center"> استعراض </button>
                                    </div>
                                </div>
                            </form>
                        </div>
