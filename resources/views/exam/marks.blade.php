                ...
                <section class="breadcumb-area card bg-gradient mb-5">
                    <div class="bread-cumb-content card-body d-flex align-items-center">
                        <div class="breadcumb-heading">
                            <span class="text-white" style="padding-left:50px; font-size:50px;"> النتائج الامتحانية للطالب </span>
                        </div>
                                    ...
                                    <table class="table mb-4">
                                        <thead class="bg-gradient">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-white text-center">المادة  </th>
                                                <th scope="col" class="text-white text-center">نوع العلامة</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$exam->student->first_name}}</td>
                                                <td class="text-center">{{$exam->student->last_name}}</td>
                                                <td class="text-center">{{$exam->grade->name}}</td>
                                                <td class="text-center">{{$exam->section->number}}</td>
                                                <td class="text-center">{{$exam->subject->name}}</td>
                                                <td class="text-center">{{$exam->type}}</td>
                                                <td class="text-center">{{$exam->mark}}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
