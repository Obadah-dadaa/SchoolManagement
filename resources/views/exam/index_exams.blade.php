                ...
                <section class="breadcumb-area card bg-gradient mb-5">
                    <div class="bread-cumb-content card-body d-flex align-items-center">
                        <div class="breadcumb-heading">
                            <h2 class="text-white" style="font-size:40px;">استعراض علامة مادّة</h2>
                        </div>
                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 d-flex align-items-center">
                            <a href="marks-add.html" class="btn btn-sm btn-pill btn-outline-light ml-auto">+إضافة علامة امتحان لمادّة</a>
                        </header>
                        <div class="card-body">
                            <form action="#" class="es-form">
                                <div class="row align-items-center">
                                    <div class="col">
                                        ...
                                        <select id="day" class="add-select">
                                    ...
                                    <div class="col">
                                        ...
                                        <select id="class" class="add-select">
                                    ...
                                    <div class="col">
                                        ...
                                        <select id="section" class="add-select">
                                    ...
                                    <div class="col">
                                        <a href="" class="es-form-btn btn btn-block bg-gradient text-white">استعراض</a>
                                    </div>  </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <thead class="bg-gradient">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-white text-center">اسم الطالب</th>
												  <th scope="col" class="text-white text-center">علامة المذاكرة</th>
                                                <th scope="col" class="text-white text-center">علامة الامتحان</th>
                                           <th scope="col" class="text-white text-center">المحصّلة</th>
  <th scope="col" class="text-white text-center">النسبة المئويّة</th>
                                            </tr>
                                        </thead>
