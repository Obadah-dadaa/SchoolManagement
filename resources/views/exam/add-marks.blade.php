                ...
                <section class="es-form-area">
                    <div class="card">
                        ...
                        <div class="card-body col-lg-8 p-lg-2">
                            <form action="{{ route('exams.add') }}" method="POST" class="es-form es-add-form was-validated">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                     ...
                                     <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="section">المادّة :</label>
									    ...
									    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="section">خاص ب :</label>
                                        <select name="type" class="add-select">
                                            <option  value="مذاكرة">المذاكرة</option>
                                            <option value="نهائي">الامتحان النهائي </option>
                                            <option value="شفهي">الشفهي </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="marks"> العلامة الكاملة : </label>
                                        <input name="total_mark" type="text" placeholder="1000">
                                    </div>
                                    <div style="padding-left:60px;" class="col-lg-6  offset-lg-6 col-md-12 mb-4" >
                                        <button type="submit" class="btn bg-gradient align-items-center"> إضافة العلامات</button>
                                    </div>
                                </div>
                            </form>
                        </div>
