        ...
        <div class="u-content">
            <div class="u-body">
                ...
                <section class="es-form-area">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('exams.showmarksforstudent') }}" method="POST" class="es-form">
                                @csrf
                                <div class="row align-items-center">
                                    <div class="col">
                                        <label for="day">الصف</label>
                                    ...
                                    <div class="col">
                                          <label for="section">المادة</label>
                                        <select name="subject_id" class="add-select">
