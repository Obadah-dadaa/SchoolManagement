            ...
            <section class="breadcumb-area card bg-gradient mb-5">
                <div class="bread-cumb-content card-body d-flex align-items-center">
                    <div class="breadcumb-heading">
                        <span class="text-white" style=" padding-left:150px; font-size:50px;"> الأبناء</span>
                    </div>
                    <div class="breadcumb-image ml-auto">
                        <img src="../../assets/img/studentpro.png" style="margin-top:230px;" height="300px" width="310px" alt="">
                    </div>
                </div>
            </section>
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    <thead class="bg-gradient">
                                            ...
                                            <a class="onclick" href="{{ route('student.create',['id'=>$parent_id])}}"><i class='fas fa-user-plus' style='font-size:20px ;color:white'></i>
                                            </a></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <a class="onclick" href="{{route('finalfee.show',['id'=>$item->id])}}" alt="تعديل معلومات الطالب"> <i  class='fas fa-money-check-alt'  style='font-size:30px;color:rgb(218, 24, 24)';></i></a>&nbsp;
                                            <a class="onclick" href="{{route('student.edit',['id'=>$item->id])}}" > <i alt="تعديل معلومات الطالب" class="fas fa-2x fa-edit"  style='font-size:30px;color:rgb(218, 24, 24)'></i></a>&nbsp;
                                            <a class="onclick" href="{{route('student.destroy',['id'=>$item->id])}}"> <i class="fas fa-2x fa-trash-alt"  style='font-size:30px;color:rgb(218, 24, 24)'></i></a>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
