        ...
        <div class="u-content">
            <div class="u-body">
                ...
                <section class="breadcumb-area card bg-gradient mb-5">
                    <div class="bread-cumb-content card-body d-flex align-items-center">
                        <div class="breadcumb-heading">
                            <h2 class="text-white" style="padding-left:200px; font-size:35px;"> استعراض معلومات الأقساط المالية
                        </h2>
                        </div>
                ...
                <section class="es-form-area">
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="POST" class="es-form">
                                @csrf
                                <div class="row align-items-center">
                                    @foreach ( $financialfee as $item)
                                    <div class="col">
                                        <label for="title"> اسم الطالب:</label>
                                            <input disabled name="first_name"  placeholder={{ $item->student->first_name }}>
                                    </div>
                                    <div class="col">
                                        <label for="title"> الكنية:</label>
                                        <input disabled  name="last_name"  placeholder={{ $item->student->last_name }}>
                                    </div>

                                    <div class="col">
                                        <label for="title">القسط الكامل:</label>
                                        <input disabled  name="fees"  placeholder={{ $item->fees }}>
                                    </div>
                                    <div class="col">
                                        <label for="title">القسط المدفوع :</label>
                                        <input disabled  name="fees"  placeholder={{ $total_payment}}>
                                    </div>
                                    <div class="col">
                                        <label for="title">نسبة الخصم:</label>
                                        <input disabled  name="discounts"  placeholder={{ $item->discounts }}>
                                    </div>
                                </div>
                            </form>
                                ...
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        <thead class="bg-gradient">
                                                ...
                                                <a  href="{{ route('payment.create', ['id'=>$item->student_id]) }}"><i class='far fa-edit' style='font-size:23px ;color:white'></i>
                                                </a></th>
                                                <th scope="col" class="text-white text-center"> القسط المقبوض </th>
                                                <th scope="col" class="text-white text-center">تاريخ الدفع</th>
                                            </tr>
                                        </thead>
                                        <tbody>
