        ...
        <div class="u-content">
            <div class="u-body">
                ...
                <section class="breadcumb-area card bg-gradient mb-5">
                    <div class="bread-cumb-content card-body d-flex align-items-center">
                        <div class="breadcumb-heading">
                            <h2 class="text-white" style="padding-left:200px; font-size:40px;">إضافة رسم مالي</h2>
                        </div>
                ...
                <section class="es-form-area">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('finalfee.store') }}" method="POST" class="es-form was-validated">
                                @csrf
                                <div class="row align-items-center">
                                    <div class="col">
                                        <label for="title"> اسم الطالب:</label>
                                        <input required  name="first_name"  placeholder=" اسم الطالب">
                                    </div>
                                    <div class="col">
                                        <label for="title"> الكنية</label>
                                        <input required  name="last_name"  placeholder=" الكنية">
                                    </div>
                                    <div class="col">
                                        <label for="title"> اسم الولي:</label>
                                        <input required  name="parent"  placeholder=" اسم الولي">
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        <button type="submit" style="padding-left: 50%; margin-top:20%; margin-left:10%;" class="btn btn-danger align-items-center"> إضافة </button>
                                    </div>
                                </div>
                            </form>
                        </div>
