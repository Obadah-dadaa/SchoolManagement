            ...
            <section class="breadcumb-area card bg-gradient mb-5">
                <div class="bread-cumb-content card-body d-flex align-items-center">
                    <div class="breadcumb-heading">
                        <span class="text-white" style="padding-left:100px; font-size:60px;">أساتذة المدرسة </span>
                    </div>
                    <div class="breadcumb-image ml-auto">
                        <img src="../../assets/img/teacher-profile.png" style="margin-top:230px;" height="300px" width="300px" alt="">
                    </div>
                </div>
            </section>
            <!-- End breadcumb-area -->
                                ...
                                <table class="table mb-6">
                                    <thead class="bg-gradient">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-white text-center">اسم الأستاذ</th>
                                            <th scope="col" class="text-white text-center">البريد الإلكتروني</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td  class="text-center" ><img src="assets/img/teacher-avatar.png" alt="" width="40px" class="rounded-circle"></td>
                                            <td class="text-center">{{$item->name}}</td>
                                            <td class="text-center">{{$item->email}}</td>
                                            <td class="text-center">{{$item->phone_number}}</td>
                                            <td class="text-center"><a href="{{ route('teacher.show',['id'=>$item->id])}}" class="btn btn-outline-dark  es-am-btn">الحساب الشخصي</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
