...
<body>
    ...
    <main class="u-main" role="main">
        ...
        <!-- End Sidebar -->
        <div class="u-content">h
            <div class="u-body">
                <section class="profile-area card">
                    <div class="profile-content card-body d-flex">
                        <div class="user-image-wrap mr-4">
                            <img src="../../assets/img/teachers.png" style="padding-right:50%; padding-bottom:10%; " height="100%" width="100%" alt="">
                        </div>
                        <div class="m-3" style="padding-top:40%; ">
                            <a href="{{ route('teacher.destroy',['id'=>$teacher->id])}}" class="btn btn-outline-danger pl-4 pr-4">حذف</a>
                            <a href="{{ route('teacher.edit',['id'=>$teacher->id])}}" class="btn btn-outline-danger pl-4  pr-4">تعديل </a>
                        </div>
                        <div class="user-about">
                            <br>
                            <p  style="padding-left:30%"> الاسم الكامل : <span>{{$teacher->name}}</span></p>
                            <p style="padding-right:0%">  <span>{{ $teacher->email }} </span>  :البريد </p>
                            <p style="padding-left:25%;"> <span> {{$teacher->phone_number}} </span> :رقم الهاتف</p>

                            <p style="padding-left:60%;">  :المواد المعطاة </p>
                            <ul>
                            @foreach ($teacher->subject as $item )
                            <li style="color:#5a6a7e;">{{$item->name}}</li>
                            @endforeach
                            </ul>
                            <br>
                        </div>
