                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0"  style="font-family:'Droid Arabic Kufi', italic; font-size:30px; padding-left:270px;"> تعديل حساب المدرس </h2>
                        </header>
                        ...
                        @csrf
                           <div class="row" style="margin-right:3%">
                                <div class="col-md-6  mb-2">
                                        <label for="title">اسم الأستاذ :</label>
                                        <input name="name" value={{$teacher->name}} @disabled(true)>
                                    </div>
                                    <div class="col-md-6  mb-2">
                                        ...
                                        <select class="form-control selectpicker" multiple>
                                            ...
                                            <option name="subject[]" value="{{$items->name}}"> {{$items->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
